      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <img
              src="/profile.jpeg"
              alt="Ramanjaneyulu Simhadri - Data Engineer"
            ...
            >
              <h3 className="text-3xl font-heading font-black text-foreground drop-shadow-lg">Ramanjaneyulu S.</h3>
              <p className="text-accent font-heading font-bold text-lg mt-1 tracking-wider uppercase">Data Engineer</p>
              <div className="mt-6 flex flex-wrap gap-2">
                {["Snowflake", "dbt", "Python", "Spark"].map((skill) => (
                  <span
                    key={skill}
